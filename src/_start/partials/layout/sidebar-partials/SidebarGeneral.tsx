...
const SidebarGeneral: React.FC = () => {
  ...
  const tabs = [
    { id: 0, title: "VIREYA", color: "#ff6b81" },
    { id: 1, title: "NEOVANA", color: "#6f42c1" },
    { id: 2, title: "ZENORA", color: "#20c997" },
    { id: 3, title: "ROBOKI", color: "#fd7e14" },
    { id: 4, title: "DANH MỤC", color: "#0dcaf0" },
  ];

  const menus: Record<number, Array<{ label: string; to: string; color: string; link?: string }>> = {
    0: [
    ...
    1: [
      { label: "👤 Hồ sơ năng lực", to: "/pathfinder/ho-so-ca-nhan", color: "#6f42c1" },
      { label: "🚀 Định hướng nghề nghiệp", to: "/pathfinder/dinh-huong-phat-trien", color: "#845ef7" },
      { label: "🧠 Phân tích năng lực", to: "/pathfinder/phan-tich-nang-luc", color: "#845ef7" },
    ],
    2: [
      { label: "🌀 Void Zone", to: "/heartcore/void-zone", color: "#fd7e14" },
      { label: "☁ CloudWhisper", to: "/heartcore/cloud-whisper", color: "#fd7e14" },
    ],
    3: [
